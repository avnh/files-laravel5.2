                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9">
                                    <div class="huge"><?php echo e($data["usersTotal"]); ?></div>
                                    <div>Total Users</div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="panel panel-success">
                        <div class="panel-heading">
                            <div class="row">
                                ...
                                <div class="col-xs-9 ">
                                    <div class="huge"><?php echo e($data['uploadedFiles']); ?></div>
                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 ">
                                <div class="huge"><?php echo e($data['disk_total_space']); ?></div>
                ...
                <div class="panel panel-success">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 ">
                                <div class="huge"><?php echo e($data['disk_free_space']); ?></div>
                ...
                <div class="panel panel-yellow">
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-xs-9 ">
                                <div class="huge"><?php echo e($data['disk_used_space']); ?></div>
