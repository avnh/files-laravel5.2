...
<head>
    ...
    <script src="{{ asset('assets/js/jquery.frontbox-1.1.js') }}"></script>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    @if (Auth::check())
                        <li><a href="{{ url('user/'.Auth::user()->username.'/home') }}">Home</a></li>
                        <li><a href="{{ url('user/'.Auth::user()->username.'/dashboard') }}">Dashboard</a></li>
                        <li><a href="{{ url('user/'.Auth::user()->username.'/upload') }}">Upload</a></li>
                    @endif
                </ul>
